...
END $
														...
														/*🛍️ PROCEDIMIENTO ACTUALIZAR VENTA 🛍
_____________________________________________________________________________________________________________________________________________________*/
CREATE PROCEDURE ACTUALIZAR_VENTA (
    ...
    IN P_A_ESTADO_VENTA VARCHAR(20),
    IN P_A_ID_EMPLEADO_FK INT,
    IN P_A_ID_CLIENTE_FK INT
)
BEGIN
    UPDATE VENTA
    SET FECHA_HORA_VENTA = P_A_FECHA_HORA_VENTA,
        ...
        ESTADO_VENTA = P_A_ESTADO_VENTA,
        ID_EMPLEADO_FK = P_A_ID_EMPLEADO_FK,
        ID_CLIENTE_FK = P_A_ID_CLIENTE_FK
...
CREATE PROCEDURE ACTUALIZAR_DETALLE_VENTA (
    ...
    IN P_A_ID_VENTA_FK BIGINT,
    IN P_A_ID_PRODUCTO_FK BIGINT
)
BEGIN
    UPDATE DETALLE_VENTA
    SET CANTIDAD = P_A_CANTIDAD,
        SUB_TOTAL = P_A_SUB_TOTAL,
        ID_VENTA_FK = P_A_ID_VENTA_FK,
        ID_PRODUCTO_FK = P_A_ID_PRODUCTO_FK
    WHERE ID_DETALLE_VENTA = P_A_ID_DETALLE_VENTA;
END $

														/* 🗄️  PROCEDIMIENTO ACTUALIZAR AJUSTE INVENTARIO 🗄️
_____________________________________________________________________________________________________________________________________________________*/
CREATE PROCEDURE ACTUALIZAR_AJUSTE_INVENTARIO (
    ...
    IN P_A_DESCRIPCION VARCHAR(255),
    IN P_A_ID_EMPLEADO_FK INT
)
BEGIN
    UPDATE AJUSTE_INVENTARIO
    SET ID_PRODUCTO_FK = P_A_ID_PRODUCTO_FK,
        TIPO_AJUSTE = P_A_TIPO_AJUSTE,
        CANTIDAD_AJUSTADA = P_A_CANTIDAD_AJUSTADA,
        FECHA_AJUSTE = P_A_FECHA_AJUSTE,
        DESCRIPCION = P_A_DESCRIPCION,
        ID_EMPLEADO_FK = P_A_ID_EMPLEADO_FK
