...
(
    IN P_I_ID_PRODUCCION_FK_DET_PRODUC BIGINT,
    IN P_I_ID_MATERIA_PRIMA_FK_DET_PRODUC BIGINT,
...
BEGIN
    ...
    VALUES (P_I_ID_PRODUCCION_FK_DET_PRODUC, P_I_ID_MATERIA_PRIMA_FK_DET_PRODUC, P_I_CANTIDAD_REQUERIDA);
END $
