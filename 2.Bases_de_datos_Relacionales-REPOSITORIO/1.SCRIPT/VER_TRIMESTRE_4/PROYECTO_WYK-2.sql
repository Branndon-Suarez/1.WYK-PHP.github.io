...
(
    ...
    PASSWORD_USUARIO VARCHAR (150) UNIQUE NOT NULL,
...
CREATE TABLE AJUSTE_INVENTARIO (
	...
	CONSTRAINT ID_USUARIO_FK_AJUSTE_INVENTARIO FOREIGN KEY (ID_PROD_FK_AJUSTE_INVENTARIO) REFERENCES USUARIO (ID_USUARIO)
);
...
(
	...
	CONSTRAINT ID_MAT_PRIMA_FK_DET_FACT_COMPRA_MAT_PRIMA FOREIGN KEY (ID_MAT_PRIMA_FK_DET_FACT_COMPRA_MAT_PRIMA) REFERENCES MATERIA_PRIMA (ID_MATERIA_PRIMA),
...
(
	...
	CONSTRAINT ID_COMPRA_FK_DET_COMPRA_PRODUCTO FOREIGN KEY (ID_COMPRA_FK_DET_COMPRA_PRODUCTO) REFERENCES COMPRA (ID_COMPRA),
	ID_PROD_FK_DET_COMPRA_PRODUCTO BIGINT NOT NULL,
	CONSTRAINT ID_PROD_FK_DET_COMPRA_PRODUCTO FOREIGN KEY (ID_PROD_FK_DET_COMPRA_PRODUCTO) REFERENCES PRODUCTO (ID_PRODUCTO),
...
(
	...
	CONSTRAINT ID_MAT_PRIMA_FK_PRODUCCION FOREIGN KEY (ID_MAT_PRIMA_FK_PRODUCCION) REFERENCES MATERIA_PRIMA (ID_MATERIA_PRIMA),
