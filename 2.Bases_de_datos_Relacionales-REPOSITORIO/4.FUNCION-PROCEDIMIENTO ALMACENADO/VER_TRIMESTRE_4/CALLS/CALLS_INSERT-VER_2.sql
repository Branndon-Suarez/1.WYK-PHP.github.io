...
CALL INSERTAR_VENTA(NOW(), 15000, 1, 'Venta mostrador', 3, 'PREPARANDO', 'PENDIENTE');
CALL INSERTAR_VENTA(NOW(), 7000, 2, 'Producto entregado. Falta por pagar', 3, 'ENTREGADO', 'PENDIENTE');
CALL INSERTAR_VENTA(NOW(), 12000, NULL, 'Venta rapida', 3, 'ENTREGADO', 'PAGADA');
CALL INSERTAR_VENTA(NOW(), 20000, NULL, 'El cliente se arrepintio y se fue.', 3, 'CANCELADO', 'CANCELADA');
