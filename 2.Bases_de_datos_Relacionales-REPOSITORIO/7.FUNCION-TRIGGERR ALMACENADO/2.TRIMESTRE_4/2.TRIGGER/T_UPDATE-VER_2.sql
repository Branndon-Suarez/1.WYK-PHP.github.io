...
-- ----------------------------------------------------------
-- 👑 TRIGGER ACTUALIZAR ROL
-- ----------------------------------------------------------
CREATE TRIGGER TRIGGER_ACTUALIZAR_ROL
AFTER UPDATE ON ROL
FOR EACH ROW
BEGIN
    INSERT INTO T_ACTUALIZAR_ROL
...
-- ----------------------------------------------------------
-- 👤 TRIGGER ACTUALIZAR USUARIO
-- ----------------------------------------------------------
CREATE TRIGGER TRIGGER_ACTUALIZAR_USUARIO
AFTER UPDATE ON USUARIO
FOR EACH ROW
BEGIN
    INSERT INTO T_ACTUALIZAR_USUARIO
...
-- ----------------------------------------------------------
-- 🍞 TRIGGER ACTUALIZAR PRODUCTO
-- ----------------------------------------------------------
CREATE TRIGGER TRIGGER_ACTUALIZAR_PRODUCTO
AFTER UPDATE ON PRODUCTO
FOR EACH ROW
BEGIN
    INSERT INTO T_ACTUALIZAR_PRODUCTO
...
-- ----------------------------------------------------------
-- 🛒 TRIGGER ACTUALIZAR VENTA
-- ----------------------------------------------------------
CREATE TRIGGER TRIGGER_ACTUALIZAR_VENTA
AFTER UPDATE ON VENTA
FOR EACH ROW
BEGIN
    INSERT INTO T_ACTUALIZAR_VENTA
...
-- ----------------------------------------------------------
-- 🧾 TRIGGER ACTUALIZAR COMPRA
-- ----------------------------------------------------------
CREATE TRIGGER TRIGGER_ACTUALIZAR_COMPRA
AFTER UPDATE ON COMPRA
FOR EACH ROW
BEGIN
    INSERT INTO T_ACTUALIZAR_COMPRA
...
FOR EACH ROW
BEGIN
    INSERT INTO T_ACTUALIZAR_DET_PRODUCCION
    (T_A_ID_DETALLE_PRODUCCION,T_A_ID_PRODUCCION_FK_DET_PRODUC,T_A_ID_MATERIA_PRIMA_FK_DET_PRODUC,T_A_CANTIDAD_REQUERIDA,FECHA_ACTUALIZACION_DETALLE_PRODUCCION)
    VALUES (OLD.ID_DETALLE_PRODUCCION,OLD.ID_PRODUCCION_FK_DET_PRODUC,OLD.ID_MATERIA_PRIMA_FK_DET_PRODUC,OLD.CANTIDAD_REQUERIDA,NOW());
END $
