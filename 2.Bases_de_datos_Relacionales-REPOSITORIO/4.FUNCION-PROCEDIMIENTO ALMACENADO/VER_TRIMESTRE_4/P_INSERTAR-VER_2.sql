...
BEGIN
    ...
    VALUES (P_I_FECHA_HORA, P_I_TOTAL, P_I_NUMERO_MESA, P_I_DESCRIPCION, P_I_ID_USUARIO_FK, P_I_ESTADO);
END $
...
BEGIN
    INSERT INTO MATERIA_PRIMA (NOMBRE_MATERIA_PRIMA, FECHA_VENCIMIENTO_MATERIA_PRIMA, CANTIDAD_EXIST_MATERIA_PRIMA, PRESENTACION_MATERIA_PRIMA, DESCRIPCION_MATERIA_PRIMA, ID_USUARIO_FK_MATERIA_PRIMA, ESTADO_MATERIA_PRIMA)
    VALUES (P_I_NOMBRE, P_I_FECHA_VENCIMIENTO, P_I_CANTIDAD, P_I_PRESENTACION, P_I_DESCRIPCION, P_I_ID_USUARIO, P_I_ESTADO);
END $
