...
SELECT * FROM ACCION_ACTUALIZAR_USUARIO;
SELECT * FROM ACCION_ACTUALIZAR_TAREA;
SELECT * FROM ACCION_ACTUALIZAR_PRODUCTO;
SELECT * FROM ACCION_ACTUALIZAR_VENTA;
SELECT * FROM ACCION_ACTUALIZAR_DETALLE_VENTA;
SELECT * FROM ACCION_ACTUALIZAR_AJUSTE_INVENTARIO;
SELECT * FROM ACCION_ACTUALIZAR_MATERIA_PRIMA;
SELECT * FROM ACCION_ACTUALIZAR_COMPRA;
SELECT * FROM ACCION_ACTUALIZAR_DETALLE_COMPRA_MP;
SELECT * FROM ACCION_ACTUALIZAR_DETALLE_COMPRA_PROD;
SELECT * FROM ACCION_ACTUALIZAR_PRODUCCION;
SELECT * FROM ACCION_ACTUALIZAR_DETALLE_PRODUCCION;
