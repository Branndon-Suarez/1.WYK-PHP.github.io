...
class PedidosController {
    ...
    private function checkAccess() {
        if ((!isset($_SESSION['rol']) || $_SESSION['rol'] !== 'MESERO') && (!isset($_SESSION['rol']) || $_SESSION['rol'] !== 'ADMINISTRADOR')) {
            $_SESSION['error_message'] = 'Acceso denegado. No tienes permisos.';
    ...
    public function reports() {
        ...
        require_once __DIR__ . '/../views/layouts/heads/headDashboard-inicio.php';
        require_once __DIR__ . '/../views/pedido/dashboardPedido.php';
    }
