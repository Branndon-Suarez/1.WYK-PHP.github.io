...
VALUES (NOW(),2000,5,'Venta mesa 5',1,'ENTREGADO','PAGADA');
...
-- ----------------------------------------------------------
INSERT INTO DETALLE_COMPRA_MATERIA_PRIMA (CANTIDAD_MAT_PRIMA_COMPRADA, SUB_TOTAL_MAT_PRIMA_COMPRADA, ID_COMPRA_FK_DET_COMPRA_MAT_PRIMA, ID_MAT_PRIMA_FK_DET_COMPRA_MAT_PRIMA, ESTADO_DET_COMPRA_MAT_PRIMA)
VALUES (50,150000,1,1,1);

-- ----------------------------------------------------------
-- 🧺 INSERTAR DETALLE_COMPRA_PRODUCTO
-- ----------------------------------------------------------
INSERT INTO DETALLE_COMPRA_PRODUCTO (CANTIDAD_PROD_COMPRADO, SUB_TOTAL_PROD_COMPRADO, ID_COMPRA_FK_DET_COMPRA_PROD, ID_PROD_FK_DET_COMPRA_PROD, ESTADO_DET_COMPRA_PROD)
VALUES (10,20000,1,101,1);
...
VALUES ('Producción diaria pan',100,'Pan fresco del día',101,1,'PENDIENTE');

-- ----------------------------------------------------------
-- 📝 INSERTAR DETALLE_PRODUCCION
-- ----------------------------------------------------------
INSERT INTO DETALLE_PRODUCCION (ID_PRODUCCION, ID_MATERIA_PRIMA, CANTIDAD_REQUERIDA,FK_DET_PROD_PRODUCCION,FK_DET_PROD_MATERIA)
VALUES (1,1,20,1,1);
