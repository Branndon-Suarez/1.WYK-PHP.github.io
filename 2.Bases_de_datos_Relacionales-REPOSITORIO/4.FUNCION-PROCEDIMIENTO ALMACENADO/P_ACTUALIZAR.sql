...
EMAIL_EMPLEADO=P_A_EMAIL_EMPLEADO,ID_CARGO_FK_EMPLEADO=P_A_ID_CARGO_FK_EMPLEADO,ESTADO_EMPLEADO=P_A_ESTADO_EMPLEADO
...
IN P_A_PASSWORD_USUARIO VARCHAR(50),
...
(
IN P_A_TIPO_ACCESO ENUM('EMPLEADO','ADMINISTRADOR'),
IN P_A_ID_USUARIO_FK_US_EMPLE INT,
IN P_A_ID_EMPLEADO_FK_US_EMPLE INT
)	
BEGIN
UPDATE USUARIO_EMPLEADO
SET TIPO_ACCESO=P_A_TIPO_ACCESO,ID_EMPLEADO_FK_US_EMPLE=P_A_ID_EMPLEADO_FK_US_EMPLE
WHERE ID_USUARIO_FK_US_EMPLE=P_A_ID_USUARIO_FK_US_EMPLE;
END $	

CALL ACTUALIZAR_USUARIO_EMPLEADO('ADMINISTRADOR',9,5);
...
(
IN P_A_ID_USUARIO_FK_US_CLIENTE INT,
IN P_A_ID_CLIENTE_FK_US_CLIENTE INT
)													
BEGIN
UPDATE USUARIO_CLIENTE
SET ID_CLIENTE_FK_US_CLIENTE=P_A_ID_CLIENTE_FK_US_CLIENTE
WHERE ID_USUARIO_FK_US_CLIENTE=P_A_ID_USUARIO_FK_US_CLIENTE;
END $
...
IN P_A_CANTIDAD_MINI_MATERIA_PRIMA BIGINT,
IN P_A_CANTIDAD_MAX_MATERIA_PRIMA BIGINT,
...
CANTIDAD_MINI_MATERIA_PRIMA=P_A_CANTIDAD_MINI_MATERIA_PRIMA,CANTIDAD_MAX_MATERIA_PRIMA=P_A_CANTIDAD_MAX_MATERIA_PRIMA,
...
CALL ACTUALIZAR_MATERIA_PRIMA (5,'HARINA', '2026-01-15', 'GRAMOS', 200,500,300,'HARINAS DEL VALLE','BULTO 50KG','HARINA PARA PANADERIA',5,0);
