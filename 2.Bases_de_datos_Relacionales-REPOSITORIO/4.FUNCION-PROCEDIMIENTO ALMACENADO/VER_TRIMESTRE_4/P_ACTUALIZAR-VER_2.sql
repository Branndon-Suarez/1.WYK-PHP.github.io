...
CREATE PROCEDURE ACTUALIZAR_DETALLE_PRODUCCION (
    ...
    IN P_A_ID_PRODUCCION_FK_DET_PRODUC BIGINT,
    IN P_A_ID_MATERIA_PRIMA_FK_DET_PRODUC BIGINT,
    IN P_A_CANTIDAD_REQUERIDA DECIMAL(10,2)
)
BEGIN
    UPDATE DETALLE_PRODUCCION
    SET ID_PRODUCCION_FK_DET_PRODUC = P_A_ID_PRODUCCION_FK_DET_PRODUC,
        ID_MATERIA_PRIMA_FK_DET_PRODUC = P_A_ID_MATERIA_PRIMA_FK_DET_PRODUC,
