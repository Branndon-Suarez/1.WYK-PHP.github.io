...
-- ============================
-- TABLAS DE AUDITORÍA ACTUALIZACIÓN
-- ============================
...
CREATE TABLE ACCION_ACTUALIZAR_USUARIO 
(
...
CREATE TABLE ACCION_ACTUALIZAR_TAREA 
(
...
CREATE TABLE ACCION_ACTUALIZAR_PRODUCTO 
(
...
CREATE TABLE ACCION_ACTUALIZAR_VENTA 
(
...
CREATE TABLE ACCION_ACTUALIZAR_DETALLE_VENTA 
(
...
CREATE TABLE ACCION_ACTUALIZAR_AJUSTE_INVENTARIO 
(
    ...
    T_A_TIPO_AJUSTE ENUM('DAÑADO','ROBO','PERDIDA','CADUCADO','MUESTRA') NOT NULL,
...
CREATE TABLE ACCION_ACTUALIZAR_MATERIA_PRIMA 
(
...
CREATE TABLE ACCION_ACTUALIZAR_COMPRA 
(
...
CREATE TABLE ACCION_ACTUALIZAR_DETALLE_COMPRA_MP 
(
...
CREATE TABLE ACCION_ACTUALIZAR_DETALLE_COMPRA_PROD 
(
...
CREATE TABLE ACCION_ACTUALIZAR_PRODUCCION 
(
    ...
    T_A_ESTADO_PRODUCCION BOOLEAN NOT NULL,
    FECHA_ACTUALIZACION_PRODUCCION DATETIME NOT NULL
);

CREATE TABLE ACCION_ACTUALIZAR_DETALLE_PRODUCCION 
(
    ...
    T_A_CANTIDAD_USADA DECIMAL(10,2) NOT NULL,
