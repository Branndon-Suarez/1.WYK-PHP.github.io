...
CREATE PROCEDURE ACTUALIZAR_VENTA (
    ...
    IN P_A_ID_USUARIO_FK_VENTA INT,
...
BEGIN
    ...
    SET FECHA_HORA_VENTA = P_A_FECHA_HORA_VENTA,
        ...
        DESCRIPCION = P_A_DESCRIPCION,
        ID_USUARIO_FK_VENTA = P_A_ID_USUARIO_FK_VENTA,
...
-- PROCEDIMIENTO ACTUALIZAR RECETA
CREATE PROCEDURE ACTUALIZAR_RECETA (
    IN P_A_ID_RECETA INT,
    IN P_A_ID_PRODUCTO_FK_RECETA BIGINT,
    IN P_A_ID_MATERIA_PRIMA_FK_RECETA BIGINT,
    IN P_A_CANTIDAD_REQUERIDA DECIMAL(10,2),
    IN P_A_UNIDAD_RECETA VARCHAR(10)
)
BEGIN
    UPDATE RECETA
    SET ID_PRODUCTO_FK_RECETA = P_A_ID_PRODUCTO_FK_RECETA,
        ID_MATERIA_PRIMA_FK_RECETA = P_A_ID_MATERIA_PRIMA_FK_RECETA,
        CANTIDAD_REQUERIDA = P_A_CANTIDAD_REQUERIDA,
        UNIDAD_RECETA = P_A_UNIDAD_RECETA
    WHERE ID_RECETA = P_A_ID_RECETA;
END $
...
CREATE PROCEDURE ACTUALIZAR_DETALLE_PRODUCCION (
    ...
    IN P_A_ID_MATERIA_PRIMA BIGINT,
    IN P_A_CANTIDAD_REQUERIDA DECIMAL(10,2),
    IN P_A_CANTIDAD_USADA DECIMAL(10,2)
)
BEGIN
    ...
    SET ID_PRODUCCION = P_A_ID_PRODUCCION,
        ...
        CANTIDAD_REQUERIDA = P_A_CANTIDAD_REQUERIDA,
        CANTIDAD_USADA = P_A_CANTIDAD_USADA
