...
(
    ...
    TEL_USUARIO BIGINT UNIQUE NOT NULL,
...
(
	...
	FOREIGN KEY (ID_USUARIO_FK_PRODUCTO) REFERENCES USUARIO (ID_USUARIO),
...
CREATE TABLE VENTA (
    ...
    FOREIGN KEY (ID_USUARIO_FK_VENTA) REFERENCES USUARIO (ID_USUARIO),
    ESTADO_VENTA ENUM('PENDIENTE', 'ENTREGADA', 'PAGADA', 'CANCELADA') NOT NULL
);
...
CREATE TABLE DETALLE_VENTA (
    ...
    FOREIGN KEY (ID_VENTA_FK_DET_VENTA) REFERENCES VENTA (ID_VENTA),
    ID_PRODUCTO_FK_DET_VENTA BIGINT NOT NULL,
    FOREIGN KEY (ID_PRODUCTO_FK_DET_VENTA) REFERENCES PRODUCTO (ID_PRODUCTO)
);

CREATE TABLE AJUSTE_INVENTARIO (
    ID_AJUSTE INT PRIMARY KEY AUTO_INCREMENT,
    FECHA_AJUSTE DATETIME NOT NULL,
    TIPO_AJUSTE ENUM('DAÑADO', 'ROBO', 'PERDIDA', 'CADUCADO', 'MUESTRA') NOT NULL,
    CANTIDAD_AJUSTADA INT NOT NULL,
    DESCRIPCION VARCHAR(255) NULL,
    ID_PROD_FK_AJUSTE_INVENTARIO BIGINT NOT NULL,
    FOREIGN KEY (ID_PROD_FK_AJUSTE_INVENTARIO) REFERENCES PRODUCTO (ID_PRODUCTO),
    ID_USUARIO_FK_AJUSTE_INVENTARIO INT NOT NULL,
	FOREIGN KEY (ID_PROD_FK_AJUSTE_INVENTARIO) REFERENCES USUARIO (ID_USUARIO)
);
...
(
	...
	FOREIGN KEY (ID_USUARIO_FK_MATERIA_PRIMA) REFERENCES USUARIO (ID_USUARIO),
...
(
	...
	FOREIGN KEY (ID_USUARIO_FK_COMPRA) REFERENCES USUARIO (ID_USUARIO),
	ESTADO_FACTURA_COMPRA ENUM('PENDIENTE','PAGADA','CANCELADA') NOT NULL
);

CREATE TABLE DETALLE_COMPRA_MATERIA_PRIMA
(
	ID_DET_COMPRA_MAT_PRIMA INT PRIMARY KEY AUTO_INCREMENT,
	...
	FOREIGN KEY (ID_COMPRA_FK_DET_COMPRA_MAT_PRIMA) REFERENCES COMPRA (ID_COMPRA),
	ID_MAT_PRIMA_FK_DET_FACT_COMPRA_MAT_PRIMA BIGINT NOT NULL,
	FOREIGN KEY (ID_MAT_PRIMA_FK_DET_FACT_COMPRA_MAT_PRIMA) REFERENCES MATERIA_PRIMA (ID_MATERIA_PRIMA),
	ESTADO_DETALLE_COMPRA_MAT_PRIMA BOOLEAN NOT NULL
);

CREATE TABLE DETALLE_COMPRA_PRODUCTO
(
	ID_DET_COMPRA_PRODUCTO INT PRIMARY KEY AUTO_INCREMENT NOT NULL,
	CANTIDAD_PRODUCTO_COMPRADO BIGINT NOT NULL,
	SUB_TOTAL_PRODUCTO_COMPRADO BIGINT NOT NULL,
	ID_COMPRA_FK_DET_COMPRA_PRODUCTO BIGINT NOT NULL,
	FOREIGN KEY (ID_COMPRA_FK_DET_COMPRA_PRODUCTO) REFERENCES COMPRA (ID_COMPRA),
	ID_PROD_FK_DET_COMPRA_PRODUCTO BIGINT NOT NULL,
	FOREIGN KEY (ID_PROD_FK_DET_COMPRA_PRODUCTO) REFERENCES PRODUCTO (ID_PRODUCTO),
	ESTADO_DET_COMPRA_PRODUCTO BOOLEAN NOT NULL
);
...
(
	...
	ID_MAT_PRIMA_FK_PRODUCCION BIGINT NOT NULL,
	FOREIGN KEY (ID_MAT_PRIMA_FK_PRODUCCION) REFERENCES MATERIA_PRIMA (ID_MATERIA_PRIMA),
	ID_PRODUCTO_FK_PRODUCCION BIGINT NOT NULL,
	FOREIGN KEY (ID_PRODUCTO_FK_PRODUCCION) REFERENCES PRODUCTO (ID_PRODUCTO),
	ID_USUARIO_FK_PRODUCCION INT NOT NULL,
	FOREIGN KEY (ID_USUARIO_FK_PRODUCCION) REFERENCES USUARIO (ID_USUARIO),
