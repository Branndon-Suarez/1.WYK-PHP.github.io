...
(
	...
	SUB_TOTAL_COMPRADA BIGINT NOT NULL,
    TIPO_ITEM ENUM('MATERIA_PRIMA', 'PRODUCTO') NOT NULL,
    TIPO_ITEM_FK BIGINT NOT NULL,
	ID_COMPRA_FK_DET_COMPRA BIGINT NOT NULL,
	CONSTRAINT ID_COMPRA_FK_DET_COMPRA FOREIGN KEY (ID_COMPRA_FK_DET_COMPRA) REFERENCES COMPRA (ID_COMPRA),
    ID_MAT_PRIMA_FK_DET_COMPRA BIGINT NULL,
    CONSTRAINT ID_MAT_PRIMA_FK_DET_COMPRA FOREIGN KEY (ID_MAT_PRIMA_FK_DET_COMPRA) REFERENCES MATERIA_PRIMA (ID_MATERIA_PRIMA),
	ID_PROD_FK_DET_COMPRA BIGINT NULL,
    CONSTRAINT ID_PROD_FK_DET_COMPRA FOREIGN KEY (ID_PROD_FK_DET_COMPRA) REFERENCES PRODUCTO (ID_PRODUCTO),
	ESTADO_DETALLE_COMPRA BOOLEAN NOT NULL
);

CREATE TABLE RECETA (
    ID_RECETA INT PRIMARY KEY AUTO_INCREMENT,
    ID_PRODUCTO_FK_RECETA BIGINT NOT NULL,
    ID_MATERIA_PRIMA_FK_RECETA BIGINT NOT NULL,
    CANTIDAD_REQUERIDA DECIMAL NOT NULL,
    -- Si una misma materia prima puede usarse con distintas unidades según la receta. Por eso no está este campo en materia prima
    UNIDAD_RECETA VARCHAR(10) NOT NULL,
    CONSTRAINT ID_PRODUCTO_FK_RECETA FOREIGN KEY (ID_PRODUCTO_FK_RECETA) REFERENCES PRODUCTO(ID_PRODUCTO),
    CONSTRAINT ID_MATERIA_PRIMA_FK_RECETA FOREIGN KEY (ID_MATERIA_PRIMA_FK_RECETA) REFERENCES MATERIA_PRIMA(ID_MATERIA_PRIMA)
);
