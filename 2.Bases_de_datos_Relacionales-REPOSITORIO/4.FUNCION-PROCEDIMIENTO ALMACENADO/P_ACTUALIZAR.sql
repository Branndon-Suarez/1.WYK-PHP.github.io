...
BEGIN
    UPDATE CARGO
    SET NOMBRE_CARGO = P_A_NOMBRE_CARGO,
        ESTADO_CARGO = P_A_ESTADO_CARGO
...
BEGIN
    UPDATE USUARIO
    SET 
      NOMBRE_USUARIO = P_A_NOMBRE_USUARIO,
      ROL = P_A_ROL,
      ...
      -- No actualiza las fechas si no se proporcionan
      FECHA_REGISTRO = IF(P_A_FECHA_REGISTRO IS NULL, FECHA_REGISTRO, P_A_FECHA_REGISTRO),
      FECHA_ULTIMA_SESION = IF(P_A_FECHA_ULTIMA_SESION IS NULL, FECHA_ULTIMA_SESION, P_A_FECHA_ULTIMA_SESION)
    WHERE 
      ID_USUARIO = P_A_ID_USUARIO;
END $
...
BEGIN
    UPDATE EMPLEADO
    SET CC_EMPLEADO = P_A_CC_EMPLEADO,
        NOMBRE_EMPLEADO = P_A_NOMBRE_EMPLEADO,
        RH_EMPLEADO = P_A_RH_EMPLEADO,
        TEL_EMPLEADO = P_A_TEL_EMPLEADO,
        EMAIL_EMPLEADO = P_A_EMAIL_EMPLEADO,
        ID_CARGO_FK_EMPLEADO = P_A_ID_CARGO_FK_EMPLEADO,
        ID_USUARIO_FK_EMPLEADO = P_A_ID_USUARIO_FK_EMPLEADO,
        ESTADO_EMPLEADO = P_A_ESTADO_EMPLEADO
...
CREATE PROCEDURE ACTUALIZAR_CLIENTE (
    ...
    IN P_A_TIPO_DOCUMENTO_CLIENTE VARCHAR(10),
...
BEGIN
    UPDATE CLIENTE
    SET NUM_DOCUMENTO_CLIENTE = P_A_NUM_DOCUMENTO_CLIENTE,
        TIPO_DOCUMENTO_CLIENTE = P_A_TIPO_DOCUMENTO_CLIENTE,
        NOMBRE_CLIENTE = P_A_NOMBRE_CLIENTE,
        TEL_CLIENTE = P_A_TEL_CLIENTE,
        EMAIL_CLIENTE = P_A_EMAIL_CLIENTE,
        ID_EMPLEADO_FK_CLIENTE = P_A_ID_EMPLEADO_FK_CLIENTE,
        ID_USUARIO_FK_CLIENTE = P_A_ID_USUARIO_FK_CLIENTE,
        ESTADO_CLIENTE = P_A_ESTADO_CLIENTE
...
CREATE PROCEDURE ACTUALIZAR_PEDIDO (
    ...
    IN P_A_ESTADO_PEDIDO VARCHAR(50)
)
BEGIN
    UPDATE PEDIDO
    SET FECHA_HORA_PEDIDO = P_A_FECHA_HORA_PEDIDO,
        NUMERO_MESA = P_A_NUMERO_MESA,
        ID_EMPLEADO_FK_PEDIDO = P_A_ID_EMPLEADO_FK_PEDIDO,
        ID_CLIENTE_FK_PEDIDO = P_A_ID_CLIENTE_FK_PEDIDO,
...
CREATE PROCEDURE ACTUALIZAR_PRODUCTO (
    ...
    IN P_A_TIPO_PRODUCTO_GENERAL VARCHAR(50),
...
BEGIN
    ...
    SET NOMBRE_PRODUCTO = P_A_NOMBRE_PRODUCTO,
        ...
        TIPO_PRODUCTO_GENERAL = P_A_TIPO_PRODUCTO_GENERAL,
        TIPO_PRODUCTO_ESPECIFICO = P_A_TIPO_PRODUCTO_ESPECIFICO,
        MARCA_PRODUCTO = P_A_MARCA_PRODUCTO,
        ID_EMPLEADO_FK_PRODUCTO = P_A_ID_EMPLEADO_FK_PRODUCTO,
...
BEGIN
    ...
    SET DESCRIPCION_DETALLE_PEDIDO = P_A_DESCRIPCION_DETALLE_PEDIDO,
        ID_PEDIDO_FK_DETALLE_PEDIDO = P_A_ID_PEDIDO_FK_DETALLE_PEDIDO,
        ID_PRODUCTO_FK_DETALLE_PEDIDO = P_A_ID_PRODUCTO_FK_DETALLE_PEDIDO,
        ESTADO_DETALLE_PEDIDO_PRODUCTO = P_A_ESTADO_DETALLE_PEDIDO_PRODUCTO
...
CREATE PROCEDURE ACTUALIZAR_FACTURA_VENTA (
    IN P_A_ID_FACTURA_VENTA BIGINT,
    ...
    IN P_A_ESTADO_FACTURA_VENTA VARCHAR(50)
)
BEGIN
    UPDATE FACTURA_VENTA
    SET TOTAL_FACTURA_VENTA = P_A_TOTAL_FACTURA_VENTA,
        FECHA_HORA_FACTURA_VENTA = P_A_FECHA_HORA_FACTURA_VENTA,
        DESCRIPCION_FACTURA_VENTA = P_A_DESCRIPCION_FACTURA_VENTA,
        ID_EMPLEADO_FK_FACTURA_VENTA = P_A_ID_EMPLEADO_FK_FACTURA_VENTA,
        ID_PEDIDO_FK_FACTURA_VENTA = P_A_ID_PEDIDO_FK_FACTURA_VENTA,
        ID_CLIENTE_FK_FACTURA_VENTA = P_A_ID_CLIENTE_FK_FACTURA_VENTA,
...
BEGIN
    ...
    SET CANTIDAD_PRODUCTO_VENDIDO = P_A_CANTIDAD_PRODUCTO_VENDIDO,
        SUB_TOTAL_PRODUCTO_VENDIDO = P_A_SUB_TOTAL_PRODUCTO_VENDIDO,
        ID_FACTURA_VENTA_FK_DET_VENTA_PRODUCTO = P_A_ID_FACTURA_VENTA_FK_DET_VENTA_PRODUCTO,
        ID_PRODUCTO_FK_DET_FACTURA_VENTA = P_A_ID_PRODUCTO_FK_DET_FACTURA_VENTA,
        ESTADO_DETALLE_VENTA_PRODUCTO = P_A_ESTADO_DETALLE_VENTA_PRODUCTO
...
BEGIN
    UPDATE PROVEEDOR
    SET CC_PROVEEDOR = P_A_CC_PROVEEDOR,
        NOMBRE_PROVEEDOR = P_A_NOMBRE_PROVEEDOR,
        TEL_PROVEEDOR = P_A_TEL_PROVEEDOR,
        EMAIL_PROVEEDOR = P_A_EMAIL_PROVEEDOR,
        ID_EMPLEADO_FK_PROVEEDOR = P_A_ID_EMPLEADO_FK_PROVEEDOR,
        ESTADO_PROVEEDOR = P_A_ESTADO_PROVEEDOR
...
CREATE PROCEDURE ACTUALIZAR_FACTURA_COMPRA (
    ...
    IN P_A_ESTADO_FACTURA_COMPRA VARCHAR(50)
)
BEGIN
    UPDATE FACTURA_COMPRA
    SET TOTAL_FACTURA_COMPRA = P_A_TOTAL_FACTURA_COMPRA,
        FECHA_HORA_FACTURA_COMPRA = P_A_FECHA_HORA_FACTURA_COMPRA,
        DESCRIPCION_FACTURA_COMPRA = P_A_DESCRIPCION_FACTURA_COMPRA,
        ID_EMPLEADO_FK_FACTURA_COMPRA = P_A_ID_EMPLEADO_FK_FACTURA_COMPRA,
        ID_PROVEEDOR_FK_FACTURA_COMPRA = P_A_ID_PROVEEDOR_FK_FACTURA_COMPRA,
...
BEGIN
    ...
    SET CANTIDAD_MATERIA_PRIMA_COMPRADA = P_A_CANTIDAD_MATERIA_PRIMA_COMPRADA,
        SUB_TOTAL_MATERIA_PRIMA_COMPRADA = P_A_SUB_TOTAL_MATERIA_PRIMA_COMPRADA,
...
BEGIN
    ...
    SET CANTIDAD_PRODUCTO_COMPRADO = P_A_CANTIDAD_PRODUCTO_COMPRADO,
        SUB_TOTAL_PRODUCTO_COMPRADO = P_A_SUB_TOTAL_PRODUCTO_COMPRADO,
        ID_FACTURA_COMPRA_FK_DET_COMPRA_PRODUCTO = P_A_ID_FACTURA_COMPRA_FK_DET_COMPRA_PRODUCTO,
        ID_PRODUCTO_FK_DET_COMPRA_PRODUCTO = P_A_ID_PRODUCTO_FK_DET_COMPRA_PRODUCTO,
        ESTADO_DETALLE_COMPRA_PRODUCTO = P_A_ESTADO_DETALLE_COMPRA_PRODUCTO
...
BEGIN
    ...
    SET NOMBRE_PRODUCCION = P_A_NOMBRE_PRODUCCION,
        ...
        MATERIA_PRIMA_GASTADA = P_A_MATERIA_PRIMA_GASTADA,
        ID_MATERIA_PRIMA_FK_PRODUCCION = P_A_ID_MATERIA_PRIMA_FK_PRODUCCION,
        ID_PRODUCTO_FK_MATERIA_PRIMA = P_A_ID_PRODUCTO_FK_MATERIA_PRIMA,
        ID_EMPLEADO_FK_PRODUCCION = P_A_ID_EMPLEADO_FK_PRODUCCION,
