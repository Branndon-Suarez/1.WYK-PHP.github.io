...
<head>
  ...
  <link rel="stylesheet" href="../ESTILOS/ESTILO-INTERFAZ-LOGIN_REGISTRO.css">
...
<body>
    <header id="SELECCIONAR-LOGIN-ROL">
        <div class="empleado">
            ...
            <span>¿Quieres ingresar como empleado?</span>
            <button class="btn transparent">
                <a href="../../0.INICIO_SESION/Index.php">EMPLEADO</a>
            </button>
        </div>

        <div class="cliente-seleccionado">
            <button class="btn transparent">CLIENTE</button>
            <span>Estas ingresando como un cliente</span>
            <lord-icon
        ...
        <div class="container">
            ...
            <div class="forms-container">
                <div class="signin-signup">
                    ...
                    <form action="control_inicio-sesion.php" class="sign-in-form" method="post">
                        ...
                        <div class="input-field">
                            ...
                            <input type="text" name="Cedula_Cliente_fk" placeholder="Digite su cédula">
                        </div>
                        ...
                        <div class="input-field">
                            ...
                            <input type="password" name="contrasena_cliente" placeholder="Digite su contraseña">
                        </div>
                        ...
                        <tr>
                            <td colspan="2" align="center"
                                <?php if(isset($_GET['errorusuario_empleado']) && $_GET['errorusuario_empleado']=="existe_error"){?>>
                                    <span id="Mensaje-Login-error"><b>⚠️ Datos incorrectos. <br> Los datos del cliente no coinciden o no se encuentran registrados.</b></span>
                                <?php }else{?>
                                <?php }?>
                            </td>
                        </tr>
                    ...
                    <form action="registrar_Cliente.php" id="formulario-registrarse" class="sign-up-form" method="post">
                        ...
                        <div class="input-field">
                            ...
                            <input type="text" name="id_cliente_fk" placeholder="Digite su cédula" required>
                        </div>
                        ...
                        <div class="input-field">
                            ...
                            <input type="password" name="password_cliente" placeholder="Cree una contraseña" required>
                        </div>
